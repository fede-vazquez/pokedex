 ...
 * @returns {Promise<Array<{id: number, order: number, name: string, height: number, weight: number, sprite: string, typeNames: Array<string>}>>} - Array con promesas que devuelven la información de cada pokémon.
 */
